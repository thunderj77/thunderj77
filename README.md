...
| Инструмент | Для чего |
|------------|----------|
| **ChatGPT (GPT-4 / GPT-4o)** | Генерация кода на Python/SQL, оптимизация запросов, написание документации, разбор сложных концепций |
| **Claude (Anthropic)** | Работа с длинным контекстом (дашборды, ETL-пайплайны), рефакторинг, анализ логов |
| **DeepSeek** | Быстрые ad-hoc задачи, проверка гипотез, парсинг и очистка данных |
| **Qwen (Qwen3.7)** | Локальный запуск для работы с чувствительными данными, написание сложных Spark-запросов |
| **Grok (xAI)** | Анализ трендов, генерация идей для A/B-гипотез, работа с неструктурированными данными |
| **Midjourney / DALL-E** | Быстрая визуализация концепций для презентаций результатов |
